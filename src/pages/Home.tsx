...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <section ref={heroRef} className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto text-white">
          ...
          >
            <Link 
              to="/book" 
              className="w-full sm:w-auto inline-block bg-[#E2725B] text-white px-8 py-4 text-sm uppercase tracking-widest hover:bg-[#c55b45] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              {c.cta}
            </Link>
            <Link 
              to="/book" 
              className="w-full sm:w-auto inline-block border-2 border-white text-white px-8 py-4 text-sm uppercase tracking-widest hover:bg-white hover:text-stone-900 transition-all duration-300 transform hover:-translate-y-1"
            >
              {c.ctaBook}
            </Link>
          </motion.div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-0 border border-stone-100 divide-x divide-y md:divide-y-0 divide-stone-100">
            <div className="flex flex-col items-center space-y-4 p-10 hover:bg-stone-50 transition-colors duration-500">
              <Sun className="w-8 h-8 text-[#E2725B]" strokeWidth={1} />
              <span className="text-[10px] uppercase tracking-[0.3em] text-stone-400 font-bold">{c.highlights.view}</span>
            </div>
            <div className="flex flex-col items-center space-y-4 p-10 hover:bg-stone-50 transition-colors duration-500">
              <Wind className="w-8 h-8 text-[#556B2F]" strokeWidth={1} />
              <span className="text-[10px] uppercase tracking-[0.3em] text-stone-400 font-bold">{c.highlights.nature}</span>
            </div>
            <div className="flex flex-col items-center space-y-4 p-10 hover:bg-stone-50 transition-colors duration-500">
              <Anchor className="w-8 h-8 text-[#004C98]" strokeWidth={1} />
              <span className="text-[10px] uppercase tracking-[0.3em] text-stone-400 font-bold">{c.highlights.design}</span>
            </div>
            <div className="flex flex-col items-center space-y-4 p-10 hover:bg-stone-50 transition-colors duration-500">
              <MapPin className="w-8 h-8 text-stone-300" strokeWidth={1} />
              <span className="text-[10px] uppercase tracking-[0.3em] text-stone-400 font-bold">{c.highlights.privacy}</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="md:w-1/2 space-y-8">
              <span className="text-[#E2725B] text-xs uppercase tracking-[0.4em] font-bold block mb-2">
      ...
      {/* Location Teaser */}
      <section className="relative py-32 bg-[#004C98] text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <span className="block text-[#E2725B] text-sm uppercase tracking-widest mb-4 font-bold">{c.locationTeaser}</span>
          <h2 className="font-serif text-3xl md:text-5xl mb-8 leading-tight">{c.locationText}</h2>
          <Link to="/location" className="inline-block border border-white/30 px-8 py-3 text-sm uppercase tracking-widest hover:bg-white hover:text-[#004C98] transition-all duration-300">
      ...
      <section className="py-32 bg-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <blockquote className="font-serif text-3xl md:text-4xl text-stone-800 italic mb-10 leading-relaxed tracking-tight">
            "{c.review1}"
          </blockquote>
          <cite className="not-italic text-[10px] uppercase tracking-[0.4em] text-stone-400 font-bold block">
            — {c.reviewAuthor1}
          </cite>
        </div>
      </section>
